...
private:
  ...
  const atoms& get_paths_format_atoms() const {
    if (m_paths_atoms.empty()) {
      m_paths_atoms.push_back(get_atom("text/uri-list"));
    }
    return m_paths_atoms;
  }
